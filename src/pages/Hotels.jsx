  ...
  return (
    <>
      ...
      <div className="max-w-8xl p-3 sm:p-4 lg:p-6 bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl mt-4 mb-6 mx-7">
        ...
        {/* Grid Layout */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-11 gap-2 sm:gap-3 px-8 lg:gap-6 items-center mb-4 sm:mb-6 w-full min-h-[110px] sm:min-h-[130px] lg:min-h-[100px]">
          ...
          <div className="lg:col-span-2 col-span-full md:col-auto">
            ...
            <div className="relative w-full">
              ...
              >
                <span className="truncate max-w-[70%]">{displayPerson}</span>
              ...
              {open && (
                <div
                  ...
                  <h3 className="font-semibold text-base sm:text-lg mb-4">Rooms</h3>
                  ...
                  <div className="mt-6 py-3 border-t">
                    <p className="text-sm font-semibold mb-3">Rooms</p>
                    <div className="grid grid-cols-3 gap-2">
                      {["Ac", "Non-Ac", "Delux"].map((cls) => (
                        <button
                          key={cls}
                          onClick={() => setrooms(cls)}
                          className={`px-3 py-2.5 rounded-xl text-xs sm:text-sm font-semibold border-2 transition-all ${rooms === cls
