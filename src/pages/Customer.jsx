...
const Customer = () => {
  ...
  const videoPath = '/customerbg.mp4'
  ...
  return (
    <>
      ...
      <div className="relative z-10 min-h-screen bg-gradient-to-br from-black/20 to-transparent pt-24 pb-20 px-4 sm:px-6 lg:px-8">

        {/* Hero Section */}
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black bg-gradient-to-r from-orange-500 to-yellow-500 bg-clip-text text-transparent mb-6 drop-shadow-2xl">
            Customer Support
          </h1>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-20">
            {/* Phone Card */}
            <div className="group bg-white/95 backdrop-blur-2xl rounded-3xl p-8 shadow-3xl hover:shadow-4xl transition-all duration-500 hover:-translate-y-2 border border-white/70">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="lg:sticky lg:top-20 lg:h-screen lg:overflow-y-auto">
              <div className="bg-white/95 backdrop-blur-2xl rounded-3xl p-8 lg:p-12 shadow-3xl border border-white/70">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-orange-500 to-yellow-500 hover:from-orange-600 hover:to-yellow-600 text-white font-bold py-4 px-8 rounded-2xl text-xl shadow-3xl hover:shadow-4xl hover:-translate-y-1 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:translate-y-0"
                  >
            ...
            {/* FAQ + Office Info - same as your original */}
            <div>
              <h2 className="text-3xl font-bold text-white/95 mb-8 drop-shadow-lg">Frequently Asked Questions</h2>

              <div className="space-y-4 mb-12">
                {faqs.map((faq, index) => (
                  <div key={index} className="bg-white/90 backdrop-blur-xl rounded-2xl p-6 shadow-2xl hover:shadow-3xl transition-all duration-300 border border-white/70">
              ...
              {/* Office Info */}
              <div className="bg-gradient-to-r from-emerald-500 to-green-600 text-white rounded-3xl p-8 shadow-3xl">
