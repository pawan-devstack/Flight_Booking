...
const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-yellow-50 to-white pt-20 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden border border-white/50">
          ...
          <div className="relative h-40 bg-gradient-to-r from-orange-400 via-yellow-400 to-orange-500">
